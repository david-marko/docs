...
The primary purpose of the Invoicing tool is to simplify the creation, sending, and management of payment requests. By generating invoices through Sarafa, you can ensure clear communication of payment terms and provide your customers with a convenient way to pay you using stablecoins.

### Viewing Your Invoices and Their Statuses

The "Invoices" section provides a centralized overview of all the invoices you have created. Here, you can:
...
* **Track invoice statuses:** Monitor the current status of each invoice, which may include:
    * **Draft:** The invoice is still being created and has not been sent.
    * **Sent:** The invoice has been sent to the customer.
    * **Viewed:** The customer has opened and viewed the invoice.
    * **Paid:** The invoice has been fully paid.
    * **Partially Paid:** The customer has made a partial payment.
    * **Overdue:** The invoice due date has passed, and it remains unpaid.
    * **Cancelled:** The invoice has been cancelled.
    {/* <Image src="/images/invoice-statuses-placeholder.png" alt="Invoice Statuses" /> */}
...
{/* <Image src="/images/invoice-checkout-link-placeholder.png" alt="Invoice Checkout Link" /> */}

This link can be sent to your customer via email or any other preferred communication channel. When the customer clicks on the link, they will be directed to a secure Sarafa payment page where they can review the invoice details and make a payment using their preferred method (e.g., their Sarafa wallet or other integrated payment options).

By using Sarafa's Invoicing feature, you can streamline your billing process, provide your customers with a professional and convenient payment experience, and easily track the status of your outstanding invoices.