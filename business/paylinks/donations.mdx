...
Sarafa's Donations feature provides a dedicated way for individuals and organizations to create and manage donation links for various causes. These links simplify the process of receiving contributions funds, making it easy for supporters to contribute.
...
1.  Navigate to the "Paylinks" section in your Sarafa dashboard.
...
3.  You will be presented with a form to configure your donation link. The required details typically include:
    ...
    * **Target Amount:** You can set a specific fundraising goal. This will be displayed on the donation page to motivate donors and track progress.
