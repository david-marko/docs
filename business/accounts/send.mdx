...
1.  Navigate to the "Send Funds" or "Withdraw" section in your Sarafa dashboard.
...
3.  You will be prompted to enter the recipient's details:
    ...
    * **Payment Description (Optional):** You can add a brief description for the transaction.
...
Sarafa currently supports sending funds via mobile money and/or bank transfer to the following countries:
