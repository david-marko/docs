...
2.  Navigate to the **Settings** and select **API**
3.  Look for an option to "Create API Key."
<img src="/images/api.png" alt="API Settings Location" />
...
<img src="/images/api-created.png" alt="API Settings Location" />
